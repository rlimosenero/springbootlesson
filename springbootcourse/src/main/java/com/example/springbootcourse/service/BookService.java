...
import com.example.springbootcourse.model.Books;
...
Books books;
	...
	public List<Book> getListBook() {
		...
		listBook.add(new Book("Spring boot for Dummies","",""));
	...
	public Book findBook(String name) {
        ...
        Book book = getListBook().stream()                        // Convert to steam
                .filter(x -> name.equals(x.getName()))        // we want name only
